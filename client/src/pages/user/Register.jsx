    ...
    <RegistrationContainer>
      ...
      <Form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
        <FormField>
          ...
          />
          {errors.username && <ErrorMessage>Username is required and must be between 6 and 32 characters</ErrorMessage>}
        </FormField>
        ...
        <FormField>
          ...
          <Input type="password" defaultValue="" {...register('repeatPassword', { required: true })} />
      ...
      <FormForSignIn>
        Do you already have an account? <SignLink to="/sign-in">Sign in</SignLink>
      </FormForSignIn>
    </RegistrationContainer>
  );
};
